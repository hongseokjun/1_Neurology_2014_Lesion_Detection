...
Group_pat                 = 'control'
Prefix_pat                = 'TLE'
Cases_pat                 = '/data/noel/noel6/seokjun/01_project/IntracorticalAnalysis/01_analysis/Demographic_data_control.txt'
Group_cont                = 'FCD'
Prefix_cont               = 'mcd'
Cases_cont                = '/data/noel/noel6/seokjun/01_project/IntracorticalAnalysis/01_analysis/Demographic_data_FCD.txt'
...
cont_case = { '027', '049', '061', '062', '063', '066', '071', '072', '073', '074', '076', '079', '080_1', '081', '082', '083', '084', '085', '086' };
pat_case  = { '301_1', '303_1', '304_1', '305_1', '306_1', '307_1', '308_1', '309_1', '310_1', '311_1', '314_1', '316_1', '317_1', '321_1', '323_1', '329_1', '332_1', '324_1', '333_1', '334_1', '335_1', '337_1', '338_1', '339_1', '340_1'  };
...
for i = 1 : size(pat_idx', 1)
    for l_r = 1 : size(Left_Right, 2)
        ...
        if(strcmp(img_contrast{1}, 't1'))
            ...
            postfix_temp = [ OutDir '/' case_num_pat{pat_idx(i)} '/' Prefix_pat '_' case_num_pat{pat_idx(i)} '_sulcalGeoDepth_' Left_Right{1, l_r} '_sm_' num2str(Kernel) '_rsl.txt' ];
